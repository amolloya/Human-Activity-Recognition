...
x1 = [[[] for i in range(66)] for j in range(250)]
...
x2 = [[[] for i in range(66)] for j in range(250)]
...
x3 = [[[] for i in range(66)] for j in range(250)]
...
X_ = np.concatenate((X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, X14, X15, X16, X17, X18, X19, X20, X21, X22, X23, X24, X25, X26, X27, X28, X29, X30, X31, X32, X33, X34, X35, X37, X38, X40, X41, X42), axis= 0)
X = X_.reshape(X_.shape[0], 250, 66, 1)
